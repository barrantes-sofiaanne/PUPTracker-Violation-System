...
<input
    type="hidden"
    id="backup-codes-data"
    value='@json($backupCodes)'>

<script>
    function downloadCodes() {
        const codesInput = document.getElementById('backup-codes-data');
        const codes = JSON.parse(codesInput ? codesInput.value : '[]');
